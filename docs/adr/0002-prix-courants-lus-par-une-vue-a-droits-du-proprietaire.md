...
Les collectes sont fermées par la sécurité par ligne, sans aucune politique, et les profils ne s'ouvrent qu'à leur propriétaire (il lit son profil et ne modifie que son nom affiché) : ni un lecteur anonyme ni un contributeur ne lit directement les collectes des autres ni les profils des autres. Le public ne lit que la vue `prix_courants`, qui calcule la médiane, applique le seuil de publication et s'exécute avec les droits de son propriétaire, donc en contournant cette fermeture. La collecte d'un contributeur, son numéro et son statut de relais ne sont jamais exposés ; seul le résultat calculé l'est.
